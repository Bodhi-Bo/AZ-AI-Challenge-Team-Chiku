...
class OpenAIKeyPool:
    ...
    def return_key(self, api_key: str, lock_token: str) -> None:
        for slot in self.slots:
    ...
    def record_key_usage(self, api_key: str, tokens_used: int) -> None:
        """
    ...
    def set_key_cooldown(self, api_key: str, cooldown_seconds: float):
        """
    ...
    def mark_key_exhausted(self, api_key: str, exhausted_msg: str):
        """
